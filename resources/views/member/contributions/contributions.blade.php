            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4 class="text-primary">My Contribution Report</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="">Home</a></li>
                        <li class="breadcrumb-item active"><a href="">Contribution Report</a>
                        </li>
                    </ol>
                </div>
            </div>
                                ...
                                <table id="example3" class="display nowrap">
                                    ...
                                    <tr>
                                        @forelse($contributions as $contribution)
                                            ...
                                            <td>₦{{number_format($contribution->savings_amount)}}</td>

                                            <td>
                                                <span class="text badge badge-primary">{{$contribution->status}}</span>
                                            </td>
                                    </tr>
                                    @empty
                                        <p>You don't have an active Ordinary Loan Requests</p>
                                    @endforelse
                                    </tbody>
                                </table>
                            </div>
