            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4 class="text-primary">Food Loan</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active"><a href="#">Food Loan</a>
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="d-flex justify-content-between doctor-info-details">
                                <div class="d-flex left-content">
                                    ...
                                    <div class="media-body">
                                        <h2 class="mb-2">Food Loan Application</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="card m-t-30">
                                    <div class="card-body">
                                        <p>
                                            Food loan:
                                            1. Less or maximum of 50,000
                                            2. Interest rate is 3%
                                            3. Form fee is #200
                                            4. You must not be in emergency or soft Loan
                                            5. Repayment period is 5 Months
                                            6. Your net balance must be able to repay the loan.
                                            7. Attach current pay slip or bank statement.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="basic-form">
                                                <form action="{{route('member.food.loan.submit')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
