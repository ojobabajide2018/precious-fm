            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4 class="text-primary">Special Loan</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="">Home</a></li>
                        <li class="breadcrumb-item active"><a href="">Special Loan</a>
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="d-flex justify-content-between doctor-info-details">
                                <div class="d-flex left-content">
                                    ...
                                    <div class="media-body">
                                        <h2 class="mb-2">Special Loan Application</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="card m-t-30">
                                    <div class="card-body">
                                        <p>
                                            Special loan: it shall be given for 200% of member’s total contribution which attract 10% interest rate payable within the period of:
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="basic-form">
                                                <form action="{{route('member.special.loan.submit')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
