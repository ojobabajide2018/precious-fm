            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4 class="text-primary">Soft Loan</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item active"><a href="../doctor-profile.html">Soft Loan</a>
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="d-flex justify-content-between doctor-info-details">
                                <div class="d-flex left-content">
                                    ...
                                    <div class="media-body">
                                        <h2 class="mb-2">Soft Loan Application</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="card m-t-30">
                                    <div class="card-body">
                                        <p>
                                            Soft loan which can also be referred to as Emergency Loan is one of the loan categories offered by the Cooperative.
                                            Soft loan is given prompt and fast approval to attend to members' emergency need, provided there is available fund at the time of request.
                                            You can obtain up to 30% of your Total Subscription balance as at the time of application.
                                            The loan attracts a single interest rate of 5% only for a maximum duration of three(3) months, repayable monthly.
                                            Please note that application fee of #500.00 only applies. For more info, kindly read the terms and condition
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row m-t-30 m-l-0 m-r-0">
                                    ...
                                    <div class="card">
                                        ...
                                        <div style="padding: 50px">
                                            ...
                                            Maximum Loan: <b>₦ 20,000</b> <br>
                                        </div>
                                        <div class="card-body">
                                            <div class="basic-form">
                                                <form action="{{route('member.soft.loan.submit')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-xl-6">
