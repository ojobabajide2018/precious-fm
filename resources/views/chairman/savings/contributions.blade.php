                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4 class="text-primary">All Member's Contributions</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active"><a href="">All Member's Contributions</a>
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display nowrap">
                                        ...
                                        <tbody>
                                        <tr>
                                            @foreach($all_contributions as $all_contribution)
                                                <td>{{$num++}}</td>
                                                <td>{{$all_contribution->user->firstname}} {{$all_contribution->user->lastname}}</td>
                                                <td>{{$all_contribution->created_at}}</td>
                                                <td>₦{{number_format($all_contribution->savings_amount)}}</td>
                                                <td>
                                                    <span class="text badge badge-primary">{{$all_contribution->status}}</span>
                                                </td>
