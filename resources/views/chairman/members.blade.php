                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4 class="text-primary">All Members</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active"><a href="">All Members</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <div class="row m-rl w-100">
                                    <div class="col-lg-4 col-sm-12">
                                        <div class="form-group">
                                            <input id="myInputTextField" class="form-control" type="search" placeholder="Search" aria-label="Search">
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group text-right">
                            <form action="{{route('export.members')}}" method="post">
                                @csrf
                                <a class='mr-4'><button class="text badge badge-primary">Export</button></a>
                            </form>
                        </div>
                    </div>
                </div>
