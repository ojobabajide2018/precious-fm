        ...
        <ul class="list-unstyled main-menu">
            ...
            <li class="has-submenu">
                ...
                <ul class="list-unstyled mm-collapse">
                    <li><a href="add-doctor.html">All Users</a></li>
                    <li><a href="doctor-list.html">Members</a></li>
                    <li> <a href="doctor-profile.html">Non Members</a> </li>
                </ul>
            </li>
            <li class="has-submenu active">
            ...
            <li class="has-submenu">
                ...
                <ul class="list-unstyled mm-collapse">
                    ...
                    <li><a href="doctor-list.html">Loan Requests</a></li>
                    <li> <a href="doctor-profile.html">Liquidity Requests</a> </li>
                </ul>
            </li>
            <li class="has-submenu">
                <a href="#" class="has-arrow mm-collapsed">
            ...
            <li class="has-submenu">
                ...
                <ul class="list-unstyled mm-collapse">
                    <li><a href="add-doctor.html"></a></li>
                    <li><a href="doctor-list.html">All Contributions</a></li>
                    <li> <a href="doctor-profile.html">Import Monthly Contribution</a> </li>
                    <li> <a href="doctor-profile.html">Account Upgrade Requests</a> </li>
                    <li> <a href="doctor-profile.html">Import Monthly Contribution</a> </li>
                </ul>
            </li>
            <li class="has-submenu">
