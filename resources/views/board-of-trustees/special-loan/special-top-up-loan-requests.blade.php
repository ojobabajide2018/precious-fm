                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4 class="text-primary">Special Top-Up Loan Requests</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="../billing-list.html">Member's Special Top-Up Loan Requests</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <table id="example3" class="display nowrap">
                                        ...
                                        <tr>
                                            @foreach($special_loan_requests as $special_loan_request)
                                                ...
                                                <td>
                                                    <form action="{{route('approve.special.top-up.loan')}}" method="post">
                                                        @csrf
                                                        ...
                                                        <a class='mr-4'><button type="submit" class="text badge badge-success">Liquidate</button></a>
                                                    </form>
